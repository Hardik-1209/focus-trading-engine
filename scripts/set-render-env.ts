...
async function setRenderEnvAndDeploy() {
  ...
  const envVars = [
    ...
    { key: 'GEMINI_MODEL', value: 'gemini-3.5-flash-lite' },
    { key: 'GEMINI_FALLBACK_MODEL', value: 'gemini-flash-lite-latest' },
    { key: 'gemini_api_key', value: process.env.gemini_api_key || '' },
    { key: 'gemini_api_key2', value: process.env.gemini_api_key2 || '' },
    { key: 'gemini_api_key3', value: process.env.gemini_api_key3 || '' },
    { key: 'gemini_api_key4', value: process.env.gemini_api_key4 || '' },
    { key: 'gemini_api_key5', value: process.env.gemini_api_key5 || '' },
    { key: 'gemini_api_key6', value: process.env.gemini_api_key6 || '' },
